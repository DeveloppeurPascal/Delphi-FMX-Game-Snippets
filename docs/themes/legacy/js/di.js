...
function setSectionState(section, expanded) {
    ...
    if (!expanded) {
        href.title = 'Expand';
        iconSpan.removeClass('collapsibleAreaExpanding').addClass('collapsibleAreaCollapsing');
        iconSpan.redraw();
        sectionContent.css('display', 'none');
    } else {
        href.title = 'Collapse';
        iconSpan.removeClass('collapsibleAreaCollapsing').addClass('collapsibleAreaExpanding');
        iconSpan.redraw();
